...
<script>
import { queryCollect, deleteCollect } from "@/api/collect";
import TablePage from "@/components/ZC/TablePage/index";
import MyForm from "@/components/ZC/Form/index";
// import theReflect from "@/config/reflect/collect";
  ...
  methods: {
    ...
    async deleteData(queryParams) {
      this.$confirm("此操作将永久删除该信息, 是否继续?", "提示", {
        ...
        .then(async () => {
          await deleteCollect({ CollectID: queryParams.CollectID });
